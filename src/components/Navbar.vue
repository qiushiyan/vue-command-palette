    ...
    <nav class="rounded dark:bg-gray-900 w-full">
        <div class="container flex flex-wrap justify-between items-center mx-auto">
            ...
            <div class="hidden justify-between items-center w-full md:flex md:w-auto md:order-1" id="navbar-search">
                ...
                <ul
                    class="flex flex-col p-4 mt-4  rounded-lg border border-gray-100 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                    <li>
                        <router-link to="/" class="block pr-4 pl-3 text-white rounded" aria-current="page">Home
                        </router-link>
                    </li>
                    <li>
                        <router-link to="/about" class="block pr-4 pl-3 text-white  rounded">
                            About</router-link>
                    </li>
                    <li>
                        <router-link to="/commands" class="block pr-4 pl-3 text-white  rounded">
